...
type PacketCarStatusData21 struct {
	Header        PacketHeader21
	CarStatusData [22]CarStatusData21
}
...
type CarStatusData22 struct {
	...
	DRSAllowed              uint8   // 0 = not allowed, 1 = allowed, -1 = unknown
	DRSActivationDistance   uint16  // 0 = DRS not available, non-zero - DRS will be available in [X] metres
	ActualTyreCompound      uint8   // See for more details: docs/TYRES.md#actual-tyre-compounds (https://github.com/hotlaps/f1-game-udp-specs/blob/main/2022/CarStatusData.h#L17)
	VisualTyreCompound      uint8   // See for more details: docs/TYRES.md#visual-tyre-compounds (https://github.com/hotlaps/f1-game-udp-specs/blob/main/2022/CarStatusData.h#L22)
	TyresAgeLaps            uint8   // Age in laps of the current set of tyres
	VehicleFIAFlags         int8    // -1 = invalid/unknown, 0 = none, 1 = green, 2 = blue, 3 = yellow, 4 = red
	ERSStoreEnergy          float32 // ERS energy store in Joules
	ERSDeployMode           uint8   // ERS deployment mode, 0 = none, 1 = medium,  2 = overtake, 3 = hotlap
...
type PacketCarStatusData22 struct {
	Header        PacketHeader22
	CarStatusData [22]CarStatusData22
}
...
type PacketCarStatusData23 struct {
	Header        PacketHeader23
	CarStatusData [22]CarStatusData23
}
