...
type TyreStintHistoryData21 struct {
...
type PacketSessionHistoryData21 struct {
	...
	LapHistoryData        [100]LapHistoryData21 // 100 laps of data max
	TyreStintsHistoryData [8]TyreStintHistoryData21
}
...
type TyreStintHistoryData22 struct {
	EndLap             uint8 // Lap the tyre usage ends on (255 of current tyre)
	TyreActualCompound uint8 // Actual tyres used by this driver
	TyreVisualCompound uint8 // Visual tyres used by this driver
}
...
type PacketSessionHistoryData22 struct {
	...
	BestSector2LapNum     uint8                 // Lap the best Sector 2 time was achieved on
	BestSector3LapNum     uint8                 // Lap the best Sector 3 time was achieved on
	LapHistoryData        [100]LapHistoryData22 // 100 laps of data max
	TyreStintsHistoryData [8]TyreStintHistoryData22
}
...
type TyreStintHistoryData23 struct {
	EndLap             uint8 // Lap the tyre usage ends on (255 of current tyre)
	TyreActualCompound uint8 // Actual tyres used by this driver
	TyreVisualCompound uint8 // Visual tyres used by this driver
}

type PacketSessionHistoryData23 struct {
	...
	BestSector2LapNum     uint8                 // Lap the best Sector 2 time was achieved on
	BestSector3LapNum     uint8                 // Lap the best Sector 3 time was achieved on
	LapHistoryData        [100]LapHistoryData23 // 100 laps of data max
	TyreStintsHistoryData [8]TyreStintHistoryData23
}
